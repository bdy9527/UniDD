...
from networks import (AlexNet, ConvNet, LeNet, MLP, ResNet18,
                      ResNet18_AP, ResNet18BN_AP, VGG11, VGG11BN)
...
def get_dataset(dataset, data_path='./data'):
    ...
    if dataset == 'CIFAR-10':
        ...
        train_dataset = TinyImageNet(data_path, split='train', download=True, transform=train_transform)
        ...
        val_dataset = TinyImageNet(data_path, split='val', download=False, transform=val_transform)
        ...
        train_dataset = ImageFolder(root=os.path.join(data_path, 'ImageNet', 'train'), transform=train_transform)
        ...
        val_dataset = ImageFolder(root=os.path.join(data_path, 'ImageNet', 'val'), transform=val_transform)

    else:
        exit('unknown dataset: %s'%dataset)

    return channel, im_size, num_classes, train_dataset, val_dataset
